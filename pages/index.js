  ...
  return (
    <div>
      ...
      <div className="flex flex-col md:flex-row flex-wrap md:pl-32 md:pr-32 md:pt-10 max-h-full">
        <Card
          href=""
          size={titleCardClicked ? "2/4" : "1/4"}
          gradient
          scroll={false}
          key="card-1"
        >
          <TitleCardContent
            titleCardClicked={titleCardClicked}
            cycleTitleCardState={cycleTitleCardState}
            locale={locale[lang]}
          />
        </Card>
        ...
        <Card animateHover size="4/12" key="card-3" scroll={false} small>
          <ContactCardContent
            contactCardClicked={contactCardClicked}
            cycleContactCardState={cycleContactCardState}
            locale={locale[lang]}
          />
        </Card>
